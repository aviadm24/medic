...
class Categorical_dose(models.Model):
    name = models.CharField(max_length=45)
...
class Manufacturing_country(models.Model):
    name = models.CharField(max_length=45)
...
# class Pharmasoft_code(models.Model):
#     name = models.CharField(max_length=45)
#
#     def __str__(self):
#         return self.name
#
#     class Meta:
#         verbose_name_plural = "קוד פרמהסופט"
#         ordering = ['name']


# class Page_num(models.Model):
#     name = models.CharField(max_length=45)
#
#     def __str__(self):
#         return self.name
